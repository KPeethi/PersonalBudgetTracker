File "C:\Users\kulka\AppData\Local\Programs\Python\Python312\Lib\site-packages\sqlalchemy\pool\impl.py", line 177, in _do_get
  ...
  File "C:\Users\kulka\AppData\Local\Programs\Python\Python312\Lib\site-packages\sqlalchemy\engine\default.py", line 625, in connect
    return self.loaded_dbapi.connect(*cargs, **cparams)  # type: ignore[no-any-return]  # NOQA: E501
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
pyodbc.InterfaceError: ('28000', '[28000] [Microsoft][ODBC Driver 17 for SQL Server][SQL Server]Login failed for user \'Name\\kulka\'. (18456) (SQLDriverConnect); [28000] [Microsoft][ODBC Driver 17 for SQL Server][SQL Server]Cannot open database "budgetdb" requested by the login. The login failed. (4060); [28000] [Microsoft][ODBC Driver 17 for SQL Server][SQL Server]Login failed for user \'Name\\kulka\'. (18456); [28000] [Microsoft][ODBC Driver 17 for SQL Server][SQL Server]Cannot open database "budgetdb" requested by the login. The login failed. (4060)')

The above exception was the direct cause of the following exception:

Traceback (most recent call last):
  File "C:\Users\kulka\OneDrive - SNHU\Desktop\capstone\PersonalBudgetTracker\main.py", line 16, in <module>
    from app import app, db
  File "C:\Users\kulka\OneDrive - SNHU\Desktop\capstone\PersonalBudgetTracker\app.py", line 54, in <module>
    app = create_app()
          ^^^^^^^^^^^^
  File "C:\Users\kulka\OneDrive - SNHU\Desktop\capstone\PersonalBudgetTracker\app.py", line 44, in create_app
    db.create_all()
  ...
  File "C:\Users\kulka\AppData\Local\Programs\Python\Python312\Lib\site-packages\sqlalchemy\engine\default.py", line 625, in connect
    return self.loaded_dbapi.connect(*cargs, **cparams)  # type: ignore[no-any-return]  # NOQA: E501
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
sqlalchemy.exc.InterfaceError: (pyodbc.InterfaceError) ('28000', '[28000] [Microsoft][ODBC Driver 17 for SQL Server][SQL Server]Login failed for user \'Name\\kulka\'. (18456) (SQLDriverConnect); [28000] [Microsoft][ODBC Driver 17 for SQL Server][SQL Server]Cannot open database "budgetdb" requested by the login. The login failed. (4060); [28000] [Microsoft][ODBC Driver 17 for SQL Server][SQL Server]Login failed for user \'Name\\kulka\'. (18456); [28000] [Microsoft][ODBC Driver 17 for SQL Server][SQL Server]Cannot open database "budgetdb" requested by the login. The login failed. (4060)')
(Background on this error at: https://sqlalche.me/e/20/rvf5)

C:\Users\kulka\OneDrive - SNHU\Desktop\capstone\PersonalBudgetTracker>